...
export class AdminsService {
  ...
  //     return this.https
  //       .get(
  //         "https://fioriqas.aabqatar.com/sap/opu/odata/sap/ZMOBILE_APP_SRV/$metadata",
  //         header
  //       )
  //       .pipe(
  //         catchError(err => {
  ...
  //     return this.https
  //       .get(
  //         "https://my341996.crm.ondemand.com/sap/c4c/odata/v1/customer/$metadata",
  //         header
  //       )
  //       .pipe(
  //         catchError(err => {
